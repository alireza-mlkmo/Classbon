      ...
      <div
        className={`${
          !isVideoLoaded || isVideoWaited
            ...
            : ""
        } h-12 bg-base-50 rounded-lg  p-2 flex items-center mt-2 gap-5`}
        lang="en"
        dir="ltr"
      >
        <Image
        ...
        <Progress value={progress} variant="primary" onClick={seekToProgressClick} className="cursor-pointer"/>
